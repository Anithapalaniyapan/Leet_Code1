    ...
    return (
      <Paper sx={{ 
        ...
        <Typography variant="body1" sx={{ color: '#555', maxWidth: '600px', mx: 'auto' }}>
          Your feedback has been submitted successfully. We'll review your responses and use them to improve our sessions.
        </Typography>
      </Paper>
    );
  }
        ...
        <Fade in={showSuccessModal}>
          <Paper sx={{ 
            ...
            <Typography variant="body1" sx={{ color: '#555', maxWidth: '400px', mx: 'auto' }}>
              Thank you for providing your valuable feedback. Your input helps us improve our sessions.
            </Typography>
          </Paper>
        </Fade>
      </Modal>
