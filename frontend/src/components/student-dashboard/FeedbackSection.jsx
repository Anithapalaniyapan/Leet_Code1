...
const FeedbackSection = ({ 
  ...
  }, [shouldShowQuestions, questions, feedbackSubmitted, questionsReady, initialCountdownComplete]);
  ...
  const onSubmitFeedback = async () => {
    ...
    // Submit feedback with notes - the success alert will be shown by the parent component
